...
def chatdis():
    ...
    e.delete(0, END)
txt=Text(a)
txt.insert(END, "\n" + "Hi this is Mr.Ted, your health assistant.")
a.title("Mr.Ted")
call_amb=Button(a, text="Call Ambulance", command=call_ambulance).place(x=500, y=150)
...
c4=Label(a, text="3.SOPs when having COVID symptoms").place(x=420, y=60)
c5=Label(a, text="4.Ordering a Self-Test Kit").place(x=500, y=80)
e=Entry(a, width=100)
